    ...
    methods: {
     // Cargar las instituciones desde la API mediante Try-Catch para manejar posibles errores
      ...
      async enviar() {
        ...
        if (this.region === 'Metropolitana') {
        ...
        }else if(this.region === 'Valparaíso'){
          ...
          emergencia.region = 'POLYGON((-36.030953 -72.764470,-36.460293 -71.105968,-37.088978 -71.174220,-36.958200 -72.334488,-36.448587, -72.863151,-36.030953 -72.764470))';
        }else if(this.region === 'Biobío'){
          emergencia.region = 'POLYGON((-38.405718 -73.522058,-37.631458 -72.552892,-38.084104 -71.065018,-37.132521 -71.208345,-36.569999 -72.921448,-38.405718 -73.522058))';
        }else if(this.region === 'La Araucanía'){
          emergencia.region = 'POLYGON((-39.367274 -73.201278,-39.583274 -71.508650,-38.491242 -73.501582,-37.658479 -72.552892,-38.110960 -71.071843,-39.367274 -73.201278))';
        }else if(this.region === 'Los Ríos'){
          emergencia.region = 'POLYGON((-40.216820 -73.699511,-40.565104 -71.897681,-39.425291 -73.208103,-39.562230 -71.727054,-40.341786 -71.706578,-40.216820 -73.699511))';
        }else if(this.region === 'Los Lagos'){
          emergencia.region = 'POLYGON((-43.727752 -73.031082,-44.067097 -71.788912,-40.279332 -74.764228,-40.596206 -71.877206,-42.046701 -71.754354,-43.727752 -73.031082))';
        }else if(this.region === 'Aysén'){
          emergencia.region = 'POLYGON((-43.723173 -73.060564,-44.05938 -71.77181,-49.15964 -73.12523,-48.511322 -75.603293,-46.719030 -75.639227,-43.723173 -73.060564))';
        }else if(this.region === 'Magallanes'){
          emergencia.region = 'POLYGON((-49.173491 -73.184613,-55.136311 -66.442327,55.882397 -67.208925,-54.081906 -73.465429,-48.861903 -75.616093,-49.173491 -73.184613))';
        }
        // Enviar emergencia
        try {
