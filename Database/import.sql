...
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Incendio forestal', 'Alta', '2023-01-15', 'Activa', ST_GeomFromText('POLYGON((-73.507689 -38.490503,-72.914427 -37.608067,-71.030272 -38.132757,-71.689452 -39.570058,-73.222045 -39.404721,-73.507689 -38.490503))', 4326), -72.9352, -38.7414, ST_PointFromText('POINT(' || '-72.9352' || ' ' || '-38.7414' || ')'), 1);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
...
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Accidente de tránsito', 'Media', '2023-05-05', 'Activa',  ST_GeomFromText('POLYGON((-73.209227 -39.418867,-71.687621 -39.571470,-71.874388 -40.580237,-72.593993 -40.688622,-73.714598 -40.245642,-73.209227 -39.418867))', 4326), -72.6361, -39.8383, ST_PointFromText('POINT(' || '-72.636' || ' ' || '-39.8383' || ')'), 2);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
...
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Incidente eléctrico', 'Baja', '2023-01-24', 'Finalizada',ST_GeomFromText('POLYGON((-73.209227 -39.418867,-71.687621 -39.571470,-71.874388 -40.580237,-72.593993 -40.688622,-73.714598 -40.245642,-73.209227 -39.418867))', 4326), -72.6361, -39.8383, ST_PointFromText('POINT(' || '-72.6361' || ' ' || '-39.8383' || ')'), 1);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region,  longitud, latitud, geom, id_institucion)
