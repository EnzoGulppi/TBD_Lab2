...
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Deslizamiento de tierra', 'Baja', '2023-02-20', 'Finalizada', ST_GeomFromText('POLYGON((-71.832473 -33.895129,-70.989272 -32.958414,-70.113113 -33.048246,-70.343826 -32.299181,-71.461684 -32.222536,-71.832473 -33.895129))', 4326), -70.9667, -34.6633, ST_PointFromText('POINT(' || '-70.9667' || ' ' || '-34.6633' || ')'), 2);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
...
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion)
 VALUES ('Temporal de viento', 'Alta', '2023-04-30', 'Finalizada', ST_GeomFromText('POLYGON((-38.405718 -73.522058,-37.631458 -72.552892,-38.084104 -71.065018,-37.132521 -71.208345,-36.569999 -72.921448,-38.405718 -73.522058))', 4326), -73.0503, -36.7789, ST_PointFromText('POINT(' || '-73.0503' || ' ' || '-36.7789' || ')'), 1);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Accidente de tránsito', 'Media', '2023-05-05', 'Activa', ST_GeomFromText('POLYGON((-40.216820 -73.699511,-40.565104 -71.897681,-39.425291 -73.208103,-39.562230 -71.727054,-40.341786 -71.706578,-40.216820 -73.699511))', 4326), -72.6361, -39.8383, ST_PointFromText('POINT(' || '-72.636' || ' ' || '-39.8383' || ')'), 2);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Incendio estructural', 'Alta', '2023-01-20', 'Finalizada', ST_GeomFromText('POLYGON((-43.723173 -73.060564,-44.05938 -71.77181,-49.15964 -73.12523,-48.511322 -75.603293,-46.719030 -75.639227,-43.723173 -73.060564))', 4326), -72.7095, -45.5714, ST_PointFromText('POINT(' || '-72.7095' || ' ' || '-45.5714' || ')'), 3);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Erupción volcánica', 'Alta', '2022-12-26', 'Activa', ST_GeomFromText('POLYGON((-49.173491 -73.184613,-55.136311 -66.442327,55.882397 -67.208925,-54.081906 -73.465429,-48.861903 -75.616093,-49.173491 -73.184613))', 4326), -72.9322, -53.1639, ST_PointFromText('POINT(' ||'-72.9322' || ' ' || '-53.1639' || ')'), 1);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
...
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Fuga de gas', 'Media', '2023-01-05', 'Activa', ST_GeomFromText('POLYGON((-38.405718 -73.522058,-37.631458 -72.552892,-38.084104 -71.065018,-37.132521 -71.208345,-36.569999 -72.921448,-38.405718 -73.522058))', 4326), -73.0503, -36.7789, ST_PointFromText('POINT(' || '-73.0503' || ' ' || '-36.7789 '|| ')'), 3);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Incidente eléctrico', 'Baja', '2023-01-24', 'Finalizada', ST_GeomFromText('POLYGON((-40.216820 -73.699511,-40.565104 -71.897681,-39.425291 -73.208103,-39.562230 -71.727054,-40.341786 -71.706578,-40.216820 -73.699511))', 4326), -72.6361, -39.8383, ST_PointFromText('POINT(' || '-72.6361' || ' ' || '-39.8383' || ')'), 1);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion)
 VALUES ('Deslave', 'Alta', '2023-02-27', 'Activa', ST_GeomFromText('POLYGON((-43.723173 -73.060564,-44.05938 -71.77181,-49.15964 -73.12523,-48.511322 -75.603293,-46.719030 -75.639227,-43.723173 -73.060564))', 4326), -72.7095, -45.5714, ST_PointFromText('POINT(' || '-72.7095' || ' ' || '-45.5714' || ')'), 2);
INSERT INTO emergencia(nombre, gravedad, fecha, estado, region, longitud, latitud, geom, id_institucion) 
VALUES ('Explosión', 'Alta', '2023-04-04', 'Finalizada', ST_GeomFromText('POLYGON((-49.173491 -73.184613,-55.136311 -66.442327,55.882397 -67.208925,-54.081906 -73.465429,-48.861903 -75.616093,-49.173491 -73.184613))', 4326), -72.9322, -53.1639, ST_PointFromText('POINT(' || '-72.9322' || ' ' || '-53.1639' || ')'), 3);
